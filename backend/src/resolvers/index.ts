import { isAuthenticatedResolver } from "./middleware/authenticated_resolver"
...
const mergedResolvers = mergeResolvers([userResolvers, videoResolver.resolvers, testResolvers])

const resolversComposition = {
    'Query.helloAuth': [isAuthenticatedResolver()],
    'Query.me': [isAuthenticatedResolver()],
    // 'Mutation.renderVideo': [isAuthenticatedResolver()], // TODO: comment in
}

const composedResolvers = composeResolvers(mergedResolvers, resolversComposition)
